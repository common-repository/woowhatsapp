...
if (wp_is_mobile() || $wooWhatsAppObject->getOption('woo_wa_button_show_desktop', 'yes') == 'yes') {
	...
	?>
	<button class="<?php echo $wooWhatsAppObject->getOption('woo_wa_button_class', $wooWhatsAppObject->default['button_class']) ?>" id="<?php echo $wooWhatsAppObject->getOption('woo_wa_button_id', 'woowhatsapp-button') ?>" style="<?php echo $wooWhatsAppObject->getOption('woo_wa_button_css') ?>" type="button" onclick="openWA()"><?php echo $button ?></button>
	<script>
