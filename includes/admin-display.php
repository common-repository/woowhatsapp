...
<div class="wrap">
    ...
    <form action="" method="post">
        ...
        <table class="form-table">
            ...
            <td>
                <input type="radio" name="woo_wa_button_show_desktop" value="yes" <?php echo $wooWhatsAppObject->getOption('woo_wa_button_show_desktop', 'yes') == 'yes' ? 'checked' : '' ?>> Yes
                <input type="radio" name="woo_wa_button_show_desktop" value="no" <?php echo $wooWhatsAppObject->getOption('woo_wa_button_show_desktop', 'yes') == 'no' ? 'checked' : '' ?>> No
            </td>
            </tr>
